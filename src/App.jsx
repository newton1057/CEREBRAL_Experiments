  ...
  return (
    <>
      <div className='App d-flex flex-column' style={{ height: "100vh" }}>
        <NavBar logged={logged} setLogged={setLogged} setStep={setStep} updateSteps={updateSteps} setStepsCompleted={updateStepsCompleted} />
          ...
          <div className='SideBar d-flex flex-column w-25 p-3 gap-3 position-relative'>
            ...
            <Accordion defaultActiveKey="0">
              <Accordion.Item eventKey="0">
                <Accordion.Header><div className='Indicator-Step'><ExclamationMark weight="bold" /></div>Experimentos</Accordion.Header>
                <Accordion.Body>
                  <p>Experimento Tradicional</p>
